...
public:
	GameObject(int w, int h) :WINDOW_WIDTH(w), WINDOW_HEIGHT(h) {};
	...
	void renderCube(unsigned int& cubeVAO, unsigned int& cubeVBO, GLfloat* cubeVertices){
		if (cubeVAO == 0)
		{
			std::vector<GLfloat> v = this->getCubeVertices();
